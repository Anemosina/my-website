  ...
  <footer id="footer">
      ...
      <div class="container">
        ...
        <div class="col-lg-3 col-md-6 footer-links">
          ...
          <div class="col-lg-3 col-md-6 footer-newsletter">
            <h4>Бюлетин</h4>
            <p>Запиши се за да получаваш пръв новостите</p>
            <form action="" method="post">
              <input type="email" name="email"><input type="submit" value="Запиши се!">
            </form>
          </div>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>Anemosina Art</span></strong>
        </div>
      </div>
